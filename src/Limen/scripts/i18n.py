...
# korean -> (key, english)
MAP = {
    "다운로드할 로컬 폴더를 선택하세요.": ("Sftp.NoLocalDirectory", "Choose a local download folder."),
    "Windows에서 사용할 수 없는 파일 이름입니다: {0}": ("Sftp.InvalidLocalName", "This filename cannot be used on Windows: {0}"),
    "링크의 재귀 전송은 지원하지 않습니다. 실제 폴더를 선택하세요: {0}": ("Sftp.LinkTransfer", "Recursive transfer through links is not supported. Select the actual directory: {0}"),
    # 공통
    "저장": ("Common.Save", "Save"),
